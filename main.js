...
const dataURL = "http://data.fixer.io/api/latest?access_key=a809c9c1baff704d89c53f0684c9b365";
...
let subscriptionList=[
    {
        ...
        abbreviation: "JMD",
        symbol: "\u0024",
        flagURL: "http://www.geonames.org/flags/l/jm.gif"
      },
];
...
subscription.addEventListener("click", closeSubscription);

function closeSubscription(event){
